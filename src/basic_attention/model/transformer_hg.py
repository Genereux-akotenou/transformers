...
class HFLikeEncoderDecoderTransformer(nn.Module):
    ...
    def forward(self, input_ids=None, attention_mask=None, labels=None, **kwargs):
        """
        Expected Arguments:
        - `input_ids`: Input tensor for the source sequence (e.g., encoder input).
        - `attention_mask`: Attention mask for the input (optional).
        - `labels`: Target sequence (e.g., decoder input).
        """
